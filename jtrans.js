...
var jTransliter = jTransliter || {
    ...
    chr: {".": "\u0964", "..": "\u0965", "A": "\u0906", "D": "\u0921", "Dh": "\u0922", "E": "\u0908", "H": "\u0903", "I": "\u0908", "Lr": "\u090c", "M": "\u0902", "MM": "\u0901", "N": "\u0923", "O": "\u0911", "R": "\u0943", "Ri": "\u090b", "S": "\u0936", "T": "\u091f", "Th": "\u0920", "U": "\u090a", "a": "\u0905", "aa": "\u0906", "ai": "\u0910", "au": "\u0914", "b": "\u092c", "B": "\u092c", "bh": "\u092d", "Bh": "\u092d", "ch": "\u091a", "chh": "\u091b", "cH": "\u091b", "CH": "\u091b", "Ch": "\u091a", "Chh": "\u091b", "d": "\u0926", "dh": "\u0927", "e": "\u090f", "f": "\u092b", "F": "\u092b", "g": "\u0917", "gh": "\u0918", "G": "\u0917", "Gh": "\u0918", "h": "\u0939", "i": "\u0907", "ee": "\u0907", "ii": "\u0908", "j": "\u091c", "J": "\u091c", "jh": "\u091d", "Jh": "\u091d", "k": "\u0915", "K": "\u0915", "c": "\u0915", "C": "\u0915", "kh": "\u0916", "Kh": "\u0916", "l": "\u0932", "L": "\u0932", "m": "\u092e", "n": "\u0928", "ng": "\u0919", "o": "\u0913", "oo": "\u090a", "ou": "\u0914", "p": "\u092a", "P": "\u092a", "ph": "\u092b", "q": "\u0915", "Q": "\u0915", "r": "\u0930", "RH": "\u090b", "s": "\u0938", "sh": "\u0937", "t": "\u0924", "th": "\u0925", "u": "\u0909", "uu": "\u090a", "v": "\u092d", "V": "\u092d", "w": "\u0935", "W": "\u0935", "x": "\u091b", "X": "\u091b", "y": "\u092f", "Y": "\u092f", "yn": "\u091e", "z": "\u091c", "Z": "\u091c", "Gy": "\u091c\u094d\u091e", "Gn": "\u091c\u094d\u091e"}, 
    type: function(t) {
        if (!t)
            return'X';
        if (t.match(/[0-9]/))
            ...
            return'X';
    }, getType: this.type, char: function(t) {
...
document.addEventListener('keydown', function(a) {
    ...
    if (k == 17) {
        if (b.getAttribute('data-transliter') == 'resume') {
            ...
            c.innerHTML = 'jTtransliter is paused. Press Ctrl key to resume, Esc to close.';
        } else {
            b.setAttribute('data-transliter', 'resume');
            c.innerHTML = 'jTtransliter is active. Press Ctrl key to pause, Esc to close.';
        }
    }
});
dgi("jtrans-copy").addEventListener('click', function(c) {
    ...
    e.innerText = dgi('jtrans-area').value;
